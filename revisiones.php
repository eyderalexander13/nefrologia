...
.menu-button:hover {
  ...
  .collage {
        ...
        background-color: #444; /* Color de fondo gris claro */
...
<h1>Revisiones de tema del Servicio de Nefrolog&iacute;a pedi&aacute;trica</h1>
<p>En esta secci&oacute;n encontrar&aacute;s informaci&oacute;n esencial sobre las presentaciones de revisiones de tema de la rotaci&oacute;n de nefrolog&iacute;a pedi&aacute;trica. Este espacio est&aacute; especialmente dise&ntilde;ado para estudiantes de medicina, m&eacute;dicos internos y residentes de nefrolog&iacute;a pedi&aacute;trica.</p>

<div class="collage">

<?php
$directory = 'imagenes/revisiones/'; // Directorio donde están tus imágenes
...
<?php foreach ($images as $image): ?>
    ...
    ?>
    <a href="#" class="pdf-link" data-pdf="revisiones/<?php echo $filename; ?>.pdf">
