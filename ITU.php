...
<h1>Gu&iacute;as cl&iacute;nicas sobre infección del tracto urinario (ITU)</h1>
<p>En esta secci&oacute;n encontrar&aacute;s informaci&oacute;n esencial sobre las gu&iacute;as cl&iacute;nicas sobre ITU del Servicio de Nefrolog&iacute;a Pedi&aacute;trica. Este espacio est&aacute; especialmente dise&ntilde;ado para estudiantes de medicina, m&eacute;dicos internos y residentes de nefrolog&iacute;a pedi&aacute;trica.</p>

<div class="collage">

<?php
$directory = 'imagenes/guias/ITU/'; // Directorio donde están tus imágenes
...
<?php foreach ($images as $image): ?>
    ...
    ?>
    <a href="#" class="pdf-link" data-pdf="documentos/<?php echo $filename; ?>.pdf">
